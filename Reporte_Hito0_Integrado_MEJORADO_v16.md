...
**2. Avanzar hacia Items Design desde las progresiones, no desde los nombres de los atributos.** Evitar que el diseño de tareas reproduzca la lógica de la primera aproximación, construyendo preguntas directamente a partir del nombre institucional de un atributo en lugar de partir de su Construct Map revisado.
