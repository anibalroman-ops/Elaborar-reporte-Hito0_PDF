...
La Figura 7 integra estas evidencias en una sola representación: el panel A compara la distribución WLE de los 991 estudiantes con las dificultades de los diez ítems sobre la misma escala logit, mientras que el panel B muestra la información y el error estándar de medición de manera condicional a \(\theta\).


![Figura 7. Focalización y precisión condicional de la prueba individual bajo el modelo de Rasch](figuras/figura-07-focalizacion-rasch.png)

**Figura 7.** *Focalización y precisión condicional de la prueba individual bajo el modelo de Rasch.* El panel A presenta la distribución de las posiciones WLE de 991 estudiantes y las dificultades estimadas de los diez ítems sobre una escala común en logits. El panel B muestra la función de información del instrumento y el error estándar de medición (SEM) a lo largo del continuo. Las dificultades se concentran entre −3,337 y −0,274 logits y la máxima información se ubica aproximadamente en \(\theta=-1,15\), lo que muestra una mejor focalización hacia la zona baja-media que hacia posiciones altas del continuo.

La lectura conjunta de ambos paneles permite precisar el problema de focalización. En el panel A, **ninguno de los diez ítems presenta dificultad positiva**: incluso los ítems más difíciles, I04 e I07, se sitúan en −0,274 logits, mientras que I10 se localiza en −3,337 logits. La distribución WLE de los estudiantes se extiende hacia posiciones superiores a la localización de todos los ítems, de modo que en la zona media-alta y alta existen estudiantes pero no tareas de dificultad comparable que aporten suficiente información para diferenciarlos. Este desajuste es coherente con la concentración de puntajes altos observada previamente —93 de 991 estudiantes, 9,38 %, alcanzaron 10/10— y sugiere que el instrumento resultó relativamente fácil para una fracción relevante de la cohorte.

El panel B muestra la consecuencia métrica de esa focalización: la información del conjunto alcanza su máximo alrededor de \(\theta=-1,15\), mientras que el SEM es menor en esa misma región y aumenta a medida que la posición estimada se aleja de ella. Hacia valores positivos, la caída de información indica que diferencias reales entre estudiantes de desempeño alto se traducen en estimaciones menos precisas. Por tanto, la principal conclusión de la Figura 7 no es simplemente que los ítems sean "fáciles", sino que **la prueba concentra su capacidad de medición en una región inferior a aquella donde se ubica una parte relevante de la cohorte**. Para un rediseño orientado a diagnóstico de ingreso, este patrón respalda la incorporación de tareas de mayor dificultad y mayor riqueza de evidencia en la zona media-alta y alta del continuo.

La **Figura 8** complementa la Figura 7 mostrando cómo el puntaje total observado se transforma en una posición WLE bajo el modelo de Rasch. Los once puntajes posibles, de 0 a 10 aciertos, se asocian con posiciones estimadas que se extienden aproximadamente desde −5,10 hasta 2,07 logits. La relación es monótona —a mayor puntaje, mayor posición estimada—, pero las distancias entre posiciones WLE asociadas a puntajes consecutivos no son constantes. En la zona central los incrementos son relativamente graduales, mientras que en los extremos, especialmente entre 9 y 10 aciertos, la separación aumenta.

Este comportamiento debe leerse junto con la focalización y la precisión condicional presentadas en la Figura 7. La ampliación de las distancias en el extremo superior no implica que un punto adicional represente allí una ganancia sustantiva excepcionalmente grande; refleja la transformación no lineal del puntaje bruto a la escala logit y la menor información disponible cuando existen pocas tareas adecuadamente localizadas en esa región. El tamaño de los puntos representa la frecuencia de estudiantes para cada puntaje y hace visible la concentración de observaciones en la zona alta, incluido el grupo de 93 estudiantes que obtuvo 10/10. En conjunto, ambas figuras muestran que el instrumento ordena el desempeño de manera coherente, pero ofrece menor resolución para distinguir diferencias dentro de la zona superior.

![Figura 8. Puntaje observado y posición WLE en la prueba individual](figuras/figura-08-puntaje-habilidad-individual.png)

**Figura 8.** *Relación entre puntaje observado y posición estimada (WLE) en la prueba individual en línea bajo el modelo de Rasch.* Se representan los once puntajes posibles (0–10) y la posición WLE correspondiente para 991 estudiantes; el tamaño de los puntos indica la frecuencia de estudiantes en cada puntaje. La mayor separación entre posiciones estimadas en los extremos, particularmente en el superior, es coherente con la menor información disponible en esas regiones. Esta figura complementa la evidencia de focalización e información condicional presentada en la Figura 7.
...
![Figura 9. Estructura empírica observada frente a la estructura nominal declarada, situación de desempeño grupal](figuras/figura-09-estructura-empirica.png)
...
![Figura 11. Mapa grupo–umbrales bajo el Partial Credit Model](figuras/figura-11-pcm-mapa-grupo-umbrales.png)
...
![Figura 13. Puntaje observado y posición WLE en la situación grupal](figuras/figura-13-puntaje-habilidad-grupal.png)
...
![Figura 14. Curvas de probabilidad de categorías bajo el PCM](figuras/figura-14-funcionamiento-categorias-pcm.png)
...
![Figura 16. Trazabilidad del refinamiento: de la evidencia al mapa revisado](figuras/figura-16-trazabilidad-refinamiento.png)
...
![Figura 17. Construct Map revisado: Teoría de innovación y emprendimiento](figuras/figura-17-cm-innovacion-emprendimiento.png)
...
![Figura 18. Construct Map revisado: Diseño (tres strands interdependientes)](figuras/figura-18-cm-diseno.png)
...
![Figura 19. Construct Map revisado: Liderazgo en la acción colectiva](figuras/figura-19-cm-liderazgo.png)
...
![Figura 20. Construct Map revisado: Economía y gestión de iniciativas](figuras/figura-20-cm-economia-gestion.png)
...
![Figura 21. Construct Map revisado: integración de la contribución individual al trabajo colectivo](figuras/figura-21-cm-trabajo-grupal-individual.png)

**Figura 21.** Construct Map revisado de Integración de la contribución individual al trabajo colectivo: progresión única de cuatro waypoints. Se distingue de Liderazgo en que regula la propia contribución, no la participación o conducción de otras personas. Hipótesis vigente, pendiente de contraste empírico.
...
![Figura 22. Construct Map revisado: Comunicación (construcción, adaptación y regulación de la interacción)](figuras/figura-22-cm-comunicacion.png)
...
![Figura 23. Construct Map revisado: incorporación de perspectivas de usuarios y personas afectadas](figuras/figura-23-cm-usuarios.png)
...
![Figura 24. Construct Map revisado: razonamiento sobre seguridad y riesgos](figuras/figura-24-cm-seguridad-riesgos.png)
...
![Figura 25. Construct Map revisado: juicio ético-profesional responsable](figuras/figura-25-cm-etica.png)

**Figura 25.** Construct Map revisado de Juicio ético-profesional responsable: progresión única de cuatro waypoints, con el profesionalismo como condición transversal. Hipótesis vigente, pendiente de contraste empírico.
...
![Figura 26. Construct Map revisado: integración de perspectivas inter y multidisciplinarias](figuras/figura-26-cm-inter-multidisciplinario.png)
...
![Figura 27. Arquitectura final de los diez atributos](figuras/figura-27-arquitectura-final.png)
...
![Figura 28. Hoja de ruta de la nueva medición y agenda de validación](figuras/figura-28-hoja-de-ruta.png)
...
![Figura 29. Síntesis institucional del proyecto Hito 0](figuras/figura-29-sintesis-institucional.png)
