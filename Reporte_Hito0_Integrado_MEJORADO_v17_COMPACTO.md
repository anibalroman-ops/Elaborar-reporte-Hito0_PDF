...
La Facultad de Ingeniería incorporó diez atributos de innovación y emprendimiento como parte transversal del perfil de egreso y de la Trayectoria de Innovación y Emprendimiento. Para disponer de una línea base previa a los hitos evaluativos posteriores se estableció el **Hito 0**, aplicado al ingreso en la asignatura *Introducción al Diseño en Ingeniería*. Su propósito es diagnóstico y formativo: caracterizar condiciones iniciales para orientar decisiones pedagógicas y curriculares, no seleccionar, certificar, excluir ni clasificar permanentemente a estudiantes.

### 1.1. Propósito del Hito 0

El Hito 0 busca describir patrones iniciales de desarrollo, orientar apoyos y decisiones docentes, aportar evidencia para el ajuste curricular y establecer una referencia para interpretar cambios posteriores. El propio sistema de medición se considera un objeto en desarrollo: sus resultados deben utilizarse con cautela mientras no exista evidencia suficiente para sostener inferencias individuales de mayor consecuencia.

### 1.2. Los diez atributos institucionales

Los atributos son: **Comunicación; Trabajo grupal e individual; Interacción con usuarios reales; Diseño; Teoría de innovación y emprendimiento; Seguridad y riesgos; Liderazgo; Economía y gestión; Ética y profesionalismo; y Trabajo inter y multidisciplinario**. Constituyen una decisión institucional, no una taxonomía universal ni diez dimensiones psicométricamente demostradas. Marcos como EntreComp y FINCODA muestran que este dominio admite organizaciones alternativas (Bacigalupo et al., 2016; Marin-Garcia et al., 2016).

Las primeras especificaciones utilizaron las Bases Curriculares de 3.º y 4.º medio como referencia de plausibilidad para el perfil de ingreso (Ministerio de Educación de Chile, 2019).

### 1.3. El desafío de pasar de atributos a medición

Nombrar un atributo no define una variable de medición. El proyecto distingue:

> **atributo institucional → constructo de medición → evidencia observable.**

El atributo es la denominación institucional; el constructo especifica qué varía entre personas, cómo progresa y cuáles son sus fronteras; la evidencia observable corresponde a respuestas, decisiones, actuaciones o productos que permiten inferir una posición en esa variable. Esta distinción organiza todo el rediseño posterior.

### 1.4. Medición e interpretación del perfil de ingreso

Una evaluación diagnóstica es útil cuando sus resultados orientan acciones formativas y no se transforman en etiquetas fijas. Los *Standards for Educational and Psychological Testing* establecen que la validez depende del respaldo que teoría y evidencia ofrecen a interpretaciones y usos específicos de las puntuaciones (AERA, APA, & NCME, 2014). Por ello, cuanto mayores sean las consecuencias de una decisión, mayor debe ser la evidencia que la sustente. En este proyecto, el uso defendible del Hito 0 es **diagnóstico, criterial, formativo y orientado a la mejora**.

![Figura 1. Recorrido general del proyecto Hito 0](figuras/figura-01-recorrido-general.png)

**Figura 1.** *Recorrido general del proyecto de reconstrucción del Hito 0.* Distingue las etapas realizadas —diagnóstico, construcción de progresiones, juicio experto y refinamiento— de las etapas siguientes —Items Design, Outcome Space, procesos de respuesta, pilotaje y Measurement Model—.
...
Desde el enfoque adoptado, medir supone construir una **variable interpretable** y relacionarla con evidencia observable; no basta asignar puntajes. Los atributos del Hito 0 son constructos latentes: se infieren a partir de respuestas y actuaciones, no se observan directamente (Wilson & Gochyyev, 2013; Wilson, 2023).

### 2.2. Validez y respaldo de las inferencias

La validación se entiende como acumulación e integración de evidencia sobre **contenido, procesos de respuesta, estructura interna, relaciones con otras variables y consecuencias del uso**; confiabilidad/precisión y *fairness* condicionan además el alcance de las inferencias (AERA et al., 2014). Ninguna fuente, por sí sola, “valida” un instrumento.

### 2.3. Teoría Clásica de los Tests: confiabilidad y error de medición

La TCT permite describir consistencia y error mediante la relación \(X=T+E\) y coeficientes como KR-20, alfa u omega. Estos índices no equivalen a unidimensionalidad ni validez. Los modelos Rasch/PCM complementan esta perspectiva al permitir estudiar focalización y precisión condicional a lo largo del continuo (Lord & Novick, 1968; Wilson, 2023).

### 2.4. Construct modelling

El proyecto adopta el *construct modelling* de Wilson (2023), cuyo principio rector es que **el problema de medición comienza antes de escribir un ítem**. La secuencia de trabajo es:

> **nombre del atributo → variable → progresión → evidencia → tareas → puntuación → modelo → interpretación.**

### 2.5. Construct Maps y waypoints

Un **Construct Map** representa una hipótesis sustantiva sobre una variable y ordena manifestaciones cualitativamente diferentes. Sus **waypoints** no son notas, cursos ni categorías psicométricas ya demostradas; son posiciones hipotéticas revisables. Cuando un atributo requiere más de una progresión relacionada, cada una se denomina *strand* (Wilson, 2023).

![Figura 2. Ejemplo genérico de un Construct Map](figuras/figura-02-construct-map-generico.png)

**Figura 2.** Estructura genérica de cuatro waypoints. Las distancias son conceptuales y no se asumen iguales.

### 2.6. BEAR Assessment System

El BEAR Assessment System articula cuatro componentes: **Construct Map**, que define la variable; **Items Design**, que crea oportunidades de evidencia; **Outcome Space**, que organiza y puntúa las respuestas; y **Measurement Model**, que contrasta empíricamente la relación entre personas, tareas, categorías y estructura postulada (Wilson, 2023). El sistema es iterativo: evidencia posterior puede exigir revisar componentes previos.

![Figura 3. BEAR Assessment System](figuras/figura-03-bear-assessment-system.png)

**Figura 3.** Los cuatro componentes del BEAR Assessment System y su relación iterativa.

### 2.7. Estrategia general del proyecto

El reporte distingue tres planos: **(1)** diagnóstico retrospectivo de la primera aproximación (Parte II); **(2)** especificación sustantiva, juicio experto y refinamiento de los constructos (Partes III–V); y **(3)** desarrollo futuro de tareas, espacios de resultados, procesos de respuesta, pilotaje y modelamiento (Parte VI). Los resultados del tercer plano son prospectivos.
...
**Figura 4.** Cadena conceptual que organiza el paso de atributo institucional a interpretación de resultados.
...
El diagnóstico de la Parte II mostró que antes de construir nuevas tareas era necesario especificar qué variable representaba cada atributo y qué diferencias cualitativas debían observarse. Por ello, el desarrollo se concentró en Construct Maps antes de avanzar a Items Design.

### 8.2. Unidad de análisis conceptual: Construct Maps person-side

Los mapas se formularon desde una perspectiva **person-side**: describen diferencias esperables entre estudiantes respecto de una variable, aun cuando la evidencia futura pueda obtenerse en tareas individuales o grupales.

### 8.3. Fuentes utilizadas para construir los mapas

La construcción combinó definiciones institucionales, antecedentes curriculares, literatura de dominio y criterios de plausibilidad para estudiantes que ingresan a Ingeniería. Las Bases Curriculares se utilizaron como referencia de nivel, no como definición exhaustiva de los constructos.

### 8.4. Principios de construcción de medidas utilizados

Los mapas debían: definir una variable interpretable; describir posiciones cualitativamente distintas; mantener coherencia entre definición, waypoints y fronteras; evitar que “más conducta” equivaliera automáticamente a mayor desarrollo; ser potencialmente observables; y formular hipótesis susceptibles de contraste (Wilson, 2023).

### 8.5. Hipótesis inicial de unidimensionalidad sustantiva

Los diez atributos se formularon inicialmente como **progresiones unidimensionales**. Esta fue una hipótesis de trabajo, no una afirmación de dimensionalidad demostrada. La posibilidad de estructuras más complejas quedó abierta a la evidencia posterior.

### 8.6. Principio de monotonicidad sustantiva

Cada waypoint superior debía representar una transformación cualitativa coherente respecto del anterior. Este orden no presupone trayectorias idénticas entre estudiantes, equidistancia entre niveles ni linealidad estricta.

### 8.7. Cuatro waypoints como decisión inicial de modelamiento

Se utilizaron cuatro waypoints por parsimonia y comparabilidad inicial. El número cuatro no predetermina cuatro categorías de puntuación ni constituye una propiedad validada del constructo.

### 8.8. Extremos del continuo y perfil de ingreso

W1 debía representar una **manifestación mínima pero sustantiva**; W4, una forma más desarrollada pero plausible al ingreso, sin exigir experiencia profesional o formación universitaria avanzada.

### 8.9. Delimitación: qué incluye y qué no incluye cada constructo

Cada mapa explicitó evidencias centrales y exclusiones para reducir contaminación entre constructos. Ejemplos: liderazgo no equivale a cargo formal; diseño no equivale a calidad final del producto; comunicación no equivale a dominio del contenido.

### 8.10. Fronteras entre los diez atributos

Se delimitaron especialmente las fronteras **TG–LG**, **TG–IM**, **DI–UR**, **DI–EG**, **IE–EG**, **EP–SR** y **COM–dominio del contenido**. Estas fronteras eran hipótesis iniciales y varias fueron posteriormente objeto de revisión experta.

### 8.11. Relación entre Construct Map y futura evidencia

La construcción consideró si cada variable podía observarse en situaciones accesibles, pero no diseñó aún las tareas definitivas. Items Design y Outcome Space permanecieron como etapas posteriores del sistema BEAR.
...
**Nota.** Los diez mapas compartían una arquitectura inicial de una variable progresiva y cuatro waypoints; su sostenibilidad debía evaluarse mediante evidencia de contenido.

### 9.2. Síntesis comparativa de la arquitectura inicial

La arquitectura común hizo posible someter a juicio experto elementos comparables: definición, variable progresiva, orden, distinción, calibración y fronteras. Algunos atributos —especialmente Economía y gestión y Ética y profesionalismo— ya planteaban dudas de unidad conceptual; otras zonas de proximidad, como TG–LG o DI–UR, requerían contraste externo.

---

## 10. Paso hacia la evidencia de contenido

Los Construct Maps iniciales eran **hipótesis sustantivas**, no mapas validados. Antes de diseñar tareas se requería evidencia de contenido sobre relevancia, claridad, unidad, progresión, distinción entre waypoints y adecuación al perfil de ingreso. Esa necesidad dio origen al juicio experto desarrollado en la Parte IV.
...
El juicio experto se utilizó como **evidencia de contenido** para evaluar las hipótesis formuladas en los diez Construct Maps; no como certificación de que los mapas estuvieran “validados”.

### 11.2. Panel de especialistas

Participaron **cinco especialistas** con experiencia complementaria en ingeniería, innovación/emprendimiento, formación universitaria, evaluación y dominios relacionados. El panel fue intencional y pequeño, por lo que sus resultados se interpretan de manera descriptiva y sustantiva.

### 11.3. Material presentado a los expertos

Cada especialista revisó los diez mapas con definición, variable progresiva, cuatro waypoints, transiciones, delimitación y adecuación al perfil de ingreso.

### 11.4. Criterios de evaluación

Se evaluaron seis criterios: **relevancia/cobertura; claridad; coherencia/unidad; orden/progresión; distinción entre waypoints; y adecuación al perfil de ingreso/contexto**.
...
|---:|---|---|
| 1 | No cumple | Problemas importantes; requiere reformulación sustantiva |
| 2 | Cumple parcialmente | Omisiones o ambigüedades; requiere ajustes mayores |
| 3 | Cumple adecuadamente | Pertinente y comprensible; puede requerir ajustes menores |
| 4 | Cumple plenamente | Claro, coherente y apropiado; cambios mínimos o ninguno |

El formulario incluyó N/A, recomendación global por atributo y comentarios abiertos.
...
El diseño generó **300 valoraciones** (5 especialistas × 10 atributos × 6 criterios). No hubo respuestas N/A. La unidad cuantitativa principal fue la celda **atributo × criterio**.

### 12.2. V de Aiken

Se calculó V de Aiken para las 60 celdas atributo × criterio, con escala 1–4 (Aiken, 1985). Se interpretó como índice de adecuación de contenido, no como coeficiente de acuerdo, confiabilidad o prueba definitiva de validez.

### 12.3. Intervalos de confianza de la V de Aiken

Se calcularon intervalos de confianza del 95 %. Con cinco jueces fueron amplios, por lo que las diferencias entre atributos se interpretaron descriptivamente.

### 12.4. Por qué no se utilizó un punto de corte automático

No se aplicó una regla mecánica de aceptación/rechazo. La V se trianguló con comentarios, recomendaciones globales y coherencia conceptual, en concordancia con una concepción acumulativa de la validación (AERA et al., 2014; Sireci & Faulkner-Bond, 2014).

### 12.5. Estadísticos descriptivos complementarios

Se utilizaron medias, dispersión, V mínima por atributo y distribución de recomendaciones globales como contexto para la interpretación.
...
Los comentarios abiertos se analizaron mediante una estrategia **deductivo–inductiva**, complementada por análisis argumentativo y matrices de trazabilidad (Elo & Kyngäs, 2008; Hsieh & Shannon, 2005; Schreier, 2012).

### 13.2. Unidad de análisis y preparación del corpus

Los comentarios repetidos por efecto del formato de registro se deduplicaron antes del análisis. La unidad operativa fue la **unidad de significado**, permitiendo segmentar un comentario en observaciones conceptualmente distintas.

### 13.3. Codificación deductivo–inductiva

Se utilizaron códigos dirigidos sobre definición, progresión, waypoints, fronteras, observabilidad, fairness y perfil de ingreso, junto con códigos emergentes cuando el marco inicial resultaba insuficiente.

### 13.4. Análisis de la estructura argumentativa

Las unidades se descompusieron, cuando correspondía, en afirmación, razón, evidencia/ejemplo, condición y consecuencia. Se distinguieron **argumentos sustantivos** de **aportes sustantivos no argumentados**, sin convertir esa distinción en una jerarquía automática de importancia.

### 13.5. Convergencias, divergencias y casos disconfirmatorios

Se analizaron patrones convergentes, posiciones divergentes y casos que tensionaban interpretaciones dominantes. La recurrencia fue descriptiva, no una regla de mayoría (Miles et al., 2014; Morse, 2015).

### 13.6. Consolidación temática y libro de códigos

Las 142 unidades se organizaron finalmente en **84 códigos consolidados, 58 categorías y 14 temas**, agrupados para presentación en cinco macrofamilias analíticas.

### 13.7. Capas de evidencia y regla de decisión

Cada observación se asignó a la capa que debía responder: **Construct Map; arquitectura del sistema; Items Design; Outcome Space; interpretación/uso; fairness/aplicación; o validación empírica futura**. La decisión final integró pertinencia conceptual, estructura argumentativa, convergencia/divergencia, evidencia cuantitativa, literatura y nivel del sistema BEAR.
...
La V media descriptiva de las 60 celdas fue **0,748**. La señal global fue heterogénea y no justificó tratar los diez mapas como igualmente consolidados.
...
| Liderazgo | 0,722 | 0,667 (C2; C3) | 3,17 | Revisión conceptual focalizada |
| Comunicación | 0,733 | 0,667 (C3; C4) | 3,20 | Revisión focalizada |
| Ética y profesionalismo | 0,767 | 0,667 (C6) | 3,30 | Deliberación conceptual |
| Seguridad y riesgos | 0,778 | 0,667 (C6) | 3,33 | Mantener arquitectura con revisión focalizada |
| Trabajo grupal e individual | 0,778 | 0,667 (C1) | 3,33 | Revisión conceptual focalizada |
| Economía y gestión | 0,789 | 0,600 (C2) | 3,37 | Revisión focalizada prioritaria |
| Interacción con usuarios reales | 0,800 | 0,667 (C3) | 3,40 | Revisión conceptual focalizada |
| Trabajo inter y multidisciplinario | 0,878 | 0,867 (C1, C2, C3, C4 y C6) | 3,63 | Mantener con ajustes focalizados |

*Nota.* La V media es un promedio descriptivo de seis estimaciones atributo × criterio; no es una V inferencial independiente del mapa completo.

### 14.3. Resultados por criterio

**Claridad (C2)** fue, en promedio, el criterio menos favorable; **Distinción entre waypoints (C5)**, el más favorable. El problema transversal fue, por tanto, más de formulación y definición que de indistinguibilidad general entre niveles.

### 14.4. Intervalos de confianza

Los intervalos fueron amplios y se superpusieron entre atributos. Por ello, la V se utilizó para identificar señales de revisión, no para construir un ranking estadístico concluyente.
...
Diseño e IE no recibieron recomendaciones de mantener; Liderazgo fue el único atributo con una recomendación de reformular. Estas categorías fueron un insumo de triangulación, no una regla de mayoría.
...
El corpus final reunió **142 unidades de significado** procedentes de 40 comentarios fuente. Se identificaron **108 unidades con estructura argumentativa** y **34 aportes sustantivos no argumentados**. Las 142 unidades no equivalen a votos.

### 15.2. Estructura temática del corpus

| Macrofamilia | Temas |
|---|---|
| **M1. Calidad de la progresión y de los waypoints** | T1 Autenticidad del waypoint inicial; T2 Calibración del máximo; T4 Claridad/evidencia mínima; T5 Distinción/continuidad; T7 Unidad del constructo |
| **M2. Validez contextual, oportunidades y equidad** | T3 Trayectoria previa; T6 Equidad/género; T11 Contextualización y alcance |
| **M3. Delimitación sustantiva de constructos específicos** | T8 Acción colectiva/liderazgo; T9 Innovación y emprendimiento; T10 Perspectiva de usuarios |
| **M4. Operacionalización y validación de la evidencia** | T12 Puntuación/interpretación; T13 Validación futura |
| **M5. Arquitectura global del sistema** | T14 Arquitectura y fortalezas de las progresiones |

### 15.3. Nivel inicial de las progresiones

El primer waypoint debía representar una **manifestación mínima auténtica**, no ausencia o déficit. El análisis de TG precisó que esa manifestación puede ser todavía dependiente/reactiva si existe una contribución observable; la ausencia de contribución queda por debajo del mapa.

### 15.4. Unidad del constructo y continuidad de la variable progresiva

El corpus cuestionó en varios atributos si una única variable podía sostener toda la progresión. Este problema fue central en Diseño, Economía y gestión y Comunicación, y también relevante para Liderazgo y Ética/profesionalismo.

### 15.5. Fronteras conceptuales y delimitación sustantiva

Se identificaron especialmente las fronteras TG–LG, DI–UR, TG–IM y EP–SR. También se profundizó la delimitación de liderazgo distribuido, innovación/emprendimiento y la incorporación sustantiva de evidencia de usuarios.

### 15.6. Fairness, contexto y oportunidades previas

Se observaron riesgos de dependencia de trayectoria curricular, lenguaje especializado, contextos desiguales, estereotipos de género/dominancia y acceso desigual a oportunidades de interacción. Algunos riesgos exigían revisar mapas; otros se trasladaron a Items Design o aplicación.

### 15.7. Destino analítico de las observaciones

Las observaciones se distribuyeron entre modificaciones del Construct Map, requisitos de Items Design, decisiones de Outcome Space, salvaguardas de fairness y hipótesis para validación futura. **Preservar una observación no implicó modificar automáticamente el mapa.**
...
Las decisiones integraron **V de Aiken + recomendaciones globales + estructura del corpus cualitativo + convergencias/divergencias + capa de evidencia + coherencia del Construct Map**. No se sumaron mecánicamente indicadores.

### 16.2. Tipos de decisiones derivadas

La triangulación distinguió entre la **magnitud de intervención sobre el mapa** —mantener, ajustar, refinar o reespecificar— y el **destino de observaciones** que debían resolverse en tareas, puntuación, fairness o validación futura.

### 16.3. No confundir prioridad con calidad absoluta

La prioridad indica dónde la evidencia justificó mayor esfuerzo de revisión; no equivale a “mapa válido” versus “mapa inválido”.
...
V media **0,589**. El corpus cuestionó el equilibrio entre innovación y emprendimiento, el carácter del nivel inicial, la creación de valor y estereotipos de emprendimiento. **Diagnóstico: revisión conceptual prioritaria; prioridad muy alta.**

### 17.2. Diseño

V media **0,644**. La evidencia convergió en problematización insuficiente, necesidad de distinguir exploración de alternativas de evaluación, y separación entre criterios y evidencia. La posible representación propia de Ideación se trató como problema de modelamiento a contrastar, no como consecuencia de una observación singular. **Diagnóstico: revisión estructural focalizada; prioridad muy alta.**

### 17.3. Liderazgo

V media **0,722**. Se discutieron alcance de la influencia, capacidad colectiva, responsabilidad, observabilidad de LG4 y riesgo de confundir liderazgo con dominancia. **Diagnóstico: revisión conceptual focalizada; prioridad alta.**

### 17.4. Economía y gestión

V media **0,789**, pero V mínima **0,600 en Claridad**. Se identificaron sobrecarga descriptiva, posible doble capacidad y dependencia de trayectoria curricular. **Diagnóstico: revisión focalizada prioritaria; prioridad alta.**

### 17.5. Trabajo grupal e individual

V media **0,778**. La evidencia señaló el componente individual, desacuerdos/carga, frontera con Liderazgo y la necesidad de distinguir ausencia de contribución de una contribución auténtica todavía dependiente de orientación. **Diagnóstico: revisión conceptual focalizada; prioridad media-alta.**

### 17.6. Comunicación

V media **0,733**. La progresión era predominantemente productiva y dejaba subdesarrollada la recepción/regulación de la interacción. **Diagnóstico: revisión focalizada; prioridad media.**

### 17.7. Interacción con usuarios reales

V media **0,800**. El eje debía ser la influencia de la evidencia de usuarios sobre comprensión y decisiones, no la cantidad de interacción directa. **Diagnóstico: revisión conceptual focalizada; prioridad media-alta.**

### 17.8. Seguridad y riesgos

V media **0,778**. Las principales cuestiones fueron calibración de SR4, distinción entre razonamiento y conducta segura y dependencia del dominio. **Diagnóstico: mantener arquitectura con revisión focalizada; prioridad media.**

### 17.9. Ética y profesionalismo

V media **0,767**. Se examinó la unidad ética–profesionalismo, deseabilidad social y la necesidad de fundamentar explícitamente la progresión desde perspectivas de desarrollo y razonamiento moral, sin imponer una teoría única. **Diagnóstico: deliberación conceptual; prioridad media.**

### 17.10. Trabajo inter y multidisciplinario

V media **0,878**, la más alta. El mapa fue considerado globalmente sólido; las principales cuestiones fueron calibración de IM4 y distinción multi/interdisciplinaria. **Diagnóstico: mantener con ajustes focalizados; prioridad baja.**
...
| Atributo | V media | Evidencia cualitativa dominante | Diagnóstico | Prioridad |
|---|---:|---|---|---|
| Teoría de innovación y emprendimiento | 0,589 | Equilibrio I/E; W1; creación de valor; estereotipos | Revisión conceptual prioritaria | Muy alta |
| Diseño | 0,644 | Problematización; ideación; criterios vs. evidencia; unidad | Revisión estructural focalizada | Muy alta |
| Liderazgo | 0,722 | Influencia/capacidad colectiva; responsabilidad; dominancia | Revisión conceptual focalizada | Alta |
| Economía y gestión | 0,789 | Sobrecarga; posible doble capacidad; trayectoria previa | Revisión focalizada prioritaria | Alta |
| Trabajo grupal e individual | 0,778 | Límite inferior; contribución individual; desacuerdo/carga; frontera LG | Revisión conceptual focalizada | Media-alta |
| Interacción con usuarios reales | 0,800 | Influencia de evidencia; frontera DI | Revisión conceptual focalizada | Media-alta |
| Comunicación | 0,733 | Producción vs. recepción/regulación | Revisión focalizada | Media |
| Ética y profesionalismo | 0,767 | Unidad; fundamento moral; deseabilidad social | Deliberación conceptual | Media |
| Seguridad y riesgos | 0,778 | Calibración superior; razonamiento vs. conducta | Mantener con revisión focalizada | Media |
| Trabajo inter y multidisciplinario | 0,878 | Solidez global; IM4; multi/inter | Mantener con ajustes focalizados | Baja |

La prioridad deriva de triangulación, no de un umbral automático.

![Figura 15. Triangulación del juicio experto y prioridad de revisión](figuras/figura-15-triangulacion-juicio-experto.png)

**Figura 15.** *Síntesis de la triangulación de evidencia por atributo y prioridad de revisión resultante.*

---

## 19. Interpretación global del juicio experto

El panel no “validó” los mapas: aportó evidencia de contenido para distinguir **qué debía revisarse, con qué profundidad y en qué capa del sistema**. Incluso los mapas mejor evaluados permanecieron como hipótesis revisables.

---

## 20. Transición hacia el refinamiento de los Construct Maps

La Parte IV estableció la prioridad y naturaleza de la revisión por atributo. La Parte V documenta la cadena **mapa inicial → evidencia → diagnóstico → decisión → mapa revisado**, incorporando literatura focalizada cuando el problema exigía contrastar alternativas de modelamiento.
...
El proyecto diagnosticó una primera aproximación del Hito 0 que permitía describir patrones agregados, pero no sostener una medición diferenciada y precisa de los diez atributos. Sobre esa base se especificaron diez Construct Maps, se sometieron a juicio experto, se analizaron cuantitativa y cualitativamente los comentarios y se trianguló la evidencia con literatura focalizada. El resultado principal no es un nuevo test terminado, sino una **arquitectura de medición más explícita, trazable y defendible**, todavía pendiente de tareas, puntuación, procesos de respuesta, pilotaje y modelamiento.
...
Un atributo requiere definición, variable progresiva, posiciones cualitativas, fronteras y evidencia observable antes de poder medirse.

### 51.2. Un ítem no equivale a un atributo

La adscripción nominal de una pregunta no basta: debe existir alineamiento entre constructo, demanda de la tarea, evidencia, puntuación e interpretación.

### 51.3. Más confiabilidad global no significa mejor medición diferenciada

Una alta consistencia del puntaje agregado no demuestra que existan diez medidas diferenciables ni habilita subpuntuaciones por atributo.

### 51.4. Los Construct Maps son instrumentos de razonamiento, no descripciones definitivas

Los mapas hacen explícitas hipótesis que después pueden revisarse con evidencia de contenido, procesos de respuesta y datos empíricos.

### 51.5. La multidimensionalidad no debe suponerse ni evitarse por conveniencia

Cuatro atributos quedaron provisionalmente representados mediante más de una progresión; esa arquitectura deberá contrastarse empíricamente.

### 51.6. El punto inferior también debe representar aprendizaje

W1 debe contener evidencia positiva del constructo. Puede ser incipiente o dependiente, pero no mera ausencia o déficit.

### 51.7. El perfil de ingreso requiere calibración propia

Los extremos superiores deben ser plausibles al ingreso y no exigir desempeño profesional o universitario avanzado.

### 51.8. Las fronteras entre atributos son parte de la validez

Distinguir TG de LG, DI de UR o EP de SR es necesario para evitar doble interpretación de una misma actuación.

### 51.9. La evidencia grupal exige cautela para inferencias individuales

Un producto o puntaje grupal no identifica automáticamente la posición de cada integrante; la futura medición deberá producir trazabilidad individual cuando se reporte a ese nivel.

### 51.10. La validación es acumulativa

Ninguna fuente de evidencia es suficiente por sí sola. El sistema debe acumular contenido, procesos de respuesta, estructura interna, precisión, fairness y consecuencias del uso (AERA et al., 2014).
...
|---|---|
| Atributo asociado directamente a un ítem o criterio | Atributo especificado mediante Construct Map |
| Correspondencia nominal | Cadena constructo–evidencia–tarea, sujeta a verificación |
| Cobertura escasa por atributo | Múltiples oportunidades de observación proyectadas |
| Puntuación antes de especificar la variable | Variable antes de la puntuación |
| Formato relativamente uniforme | Formato de tarea según evidencia requerida |
| Evidencia grupal potencialmente sobreinterpretada | Distinción explícita entre evidencia grupal e individual |
| Rúbrica sin progresión explícita | Outcome Space derivado del Construct Map |
| Puntaje total como salida principal | Posiciones y perfiles como interpretación prioritaria |
| Modelo aplicado al final | Modelo seleccionado en función del constructo y los datos |

### 52.2. Arquitectura actual de los diez atributos

La arquitectura vigente mantiene **seis atributos unidimensionales** y **cuatro con más de una progresión provisional**: Comunicación, Diseño, Teoría de innovación y emprendimiento y Economía y gestión. En todos los casos se trata de hipótesis sustantivas pendientes de contraste empírico.
...
Cinco especialistas aportaron evidencia cualificada, pero las V de Aiken presentan intervalos amplios y deben interpretarse descriptivamente.

### 53.2. Los mapas revisados todavía no han sido contrastados con respuestas de estudiantes

El orden, distinguibilidad y observabilidad real de los waypoints siguen pendientes de pilotaje.

### 53.3. Reespecificaciones estructurales todavía provisionales

La multidimensionalidad propuesta en cuatro atributos aún no ha sido demostrada psicométricamente.

### 53.4. Literatura desigual entre atributos

La revisión documental fue focalizada y más profunda donde los problemas de modelamiento lo exigían; no constituye una revisión sistemática exhaustiva de los diez dominios.

### 53.5. Falta de evidencia de procesos de respuesta

Todavía no se ha comprobado que estudiantes interpreten y resuelvan las futuras tareas mediante los procesos previstos.

### 53.6. Falta de evidencia psicométrica de la nueva arquitectura

La estructura interna, focalización, funcionamiento de categorías y precisión solo podrán estudiarse con datos de pilotaje.

### 53.7. Limitaciones para inferencias individuales

Mientras la precisión no sea suficiente y la evidencia no identifique contribuciones individuales, deben evitarse interpretaciones finas a nivel de estudiante.
...
Debe conservarse su función diagnóstica y formativa, sin convertirse en selección, ranking o certificación.

### 54.2. La medición debe informar decisiones curriculares

Su valor institucional radica en orientar apoyos, énfasis pedagógicos y revisión curricular a partir de patrones iniciales observables.

### 54.3. El reporte debe conservar la multidimensionalidad cuando sea necesaria

No debe imponerse un puntaje global cuando la estructura vigente requiera perfiles por atributo o strand.

### 54.4. Interpretabilidad antes que simplicidad

Una salida más simple no es preferible si elimina diferencias sustantivas necesarias para interpretar el diagnóstico.

### 54.5. Gobernanza de los Construct Maps

Las definiciones y mapas deben mantenerse como documentos controlados, versionados y sujetos a revisión basada en evidencia.

### 54.6. Capacitación de evaluadores y docentes

Las tareas de desempeño requerirán criterios compartidos, entrenamiento y diseños que permitan estudiar consistencia y severidad cuando corresponda.

---

## 55. Recomendaciones institucionales

1. **Estabilizar los Construct Maps vigentes** y mantener su trazabilidad.
2. **Diseñar tareas desde las progresiones**, no desde el nombre general del atributo.
3. **Construir Outcome Spaces antes de la aplicación** y alinearlos con las variables.
4. **Estudiar procesos de respuesta y pilotar** antes de cualquier escalamiento.
5. **Diseñar rigurosamente la evaluación humana**, especialmente en desempeños grupales.
6. **Examinar fairness y precisión** antes de sostener inferencias individuales.
7. **Reportar perfiles interpretables**, evitando puntajes totales no respaldados.
...
|---|---|---|---|
| 1. Consolidación de Construct Maps | Mapas estabilizados | Contenido | Arquitectura sustantiva |
| 2. Items Design | Prototipos alineados | Constructo–tarea | Tareas para pilotaje |
| 3. Outcome Space | Scoring guides | Respuesta–variable | Puntuación preliminar |
| 4. Procesos de respuesta | Evidencia cognitiva | Interpretación efectiva | Revisión de tareas |
| 5. Pilotaje | Respuestas de estudiantes | Funcionamiento preliminar | Revisión del sistema |
| 6. Measurement Model | Modelos calibrados | Estructura y precisión | Arquitectura de puntuación |
| 7. Aplicación ampliada | Hito 0 operativo | Utilidad y consecuencias | Nuevo ciclo de mejora |

La hoja de ruta es iterativa: evidencia posterior puede requerir revisar mapas, tareas o categorías.

---

## 57. Criterios para considerar el sistema preparado para una aplicación ampliada

Antes de escalar deben existir, en conjunto: Construct Maps estabilizados; tareas alineadas; Outcome Spaces funcionales; evidencia de procesos de respuesta; categorías distinguibles; capacitación de evaluadores; evidencia inicial de dimensionalidad, focalización y precisión; revisión de fairness; y un sistema de reporte coherente con el uso diagnóstico. Ningún coeficiente aislado debe decidir el escalamiento.

---

## 58. Qué no debería hacerse

- No inferir un atributo a partir de un solo ítem o criterio.
- No confundir consistencia global con medición diferenciada.
- No transformar puntajes grupales en individuales sin evidencia.
- No equiparar automáticamente waypoints y categorías de rúbrica.
- No imponer puntajes globales a estructuras multidimensionales sin respaldo.
- No tratar los mapas actuales como psicométricamente validados.
- No escalar sin pilotaje y evidencia de procesos de respuesta.

---

## 59. Contribución institucional del proyecto

El proyecto produjo tres avances: **conceptual**, al especificar los diez atributos como variables de medición; **metodológico**, al organizar el desarrollo mediante Construct Map → Items Design → Outcome Space → Measurement Model; e **institucional**, al ofrecer una base común, trazable y revisable para construir el Hito 0.

![Figura 29. Síntesis institucional del proyecto Hito 0](figuras/figura-29-sintesis-institucional.png)

**Figura 29.** *Síntesis institucional del recorrido del proyecto Hito 0.*

---

## 60. Conclusiones generales

La principal dificultad identificada no era solo psicométrica, sino de **especificación de los constructos**. El diagnóstico permitió delimitar qué inferencias eran defendibles; los Construct Maps hicieron explícitas variables y progresiones; el juicio experto y la literatura permitieron refinar esa arquitectura; y la Parte VI define cómo convertirla en tareas, puntuación y evidencia empírica.

El estado actual es, por tanto, una **arquitectura conceptual de medición mejor fundamentada**, no un instrumento definitivo. El éxito de la siguiente etapa dependerá de que el sistema mantenga el alineamiento entre constructo, evidencia, tarea, puntuación, modelo e interpretación.
...
|---|---|---|
| Diagnóstico de la primera aproximación | Completado | — |
| Construct Maps iniciales y juicio experto | Completados | Trazabilidad conservada |
| Construct Maps revisados | Hipótesis vigentes | Procesos de respuesta y contraste empírico |
| Items Design | Desarrollo conceptual | Matrices de evidencia y prototipos |
| Outcome Space | Pendiente | Tareas diseñadas |
| Procesos de respuesta | Pendiente | Tareas y scoring guides preliminares |
| Pilotaje | Pendiente | Protocolo y conjunto de tareas |
| Measurement Model | Pendiente | Datos piloto |
| Reporte institucional | En revisión editorial | Maquetación final y cierre de referencias |
